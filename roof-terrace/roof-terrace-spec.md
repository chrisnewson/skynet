...
- **Central railings removed to cut street clutter.** The existing modern steel railings were discussed at the meeting and the officers raised *"no objection to removing them."* The central and short runs are taken out (east and west retained and re-sited), tidying the rear skyline as seen from Bristol Gardens.
...
**Net effect:** the same accepted footprint, pulled back and lowered in prominence; the store and the plain timber gone; the central railings cleared; and a bare roof turned green. This is not a departure from the pre-app design — it is that design improved along exactly the lines the officers set out, and remains comfortably *less than substantial harm*.
