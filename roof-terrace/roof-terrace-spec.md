...
- **Fall-protection glass kept visually quiet — and reflecting the final design.** The fall protection around the **hot tub** (two runs) and the **west dining edge** is **frameless toughened glass, point-fixed to the *inner* face of the parapet** — **no cap-rail or metal at the top edge, and no penetration of the roof or the parapet coping** (Part L). The officers already indicated that the **guarding around the western parapet** and a **glass balustrade** to the railings would be acceptable; this detail keeps that guarding as unobtrusive as possible — an almost-invisible sheet rather than an applied structure — and it is all in Phase 2 with the building.
