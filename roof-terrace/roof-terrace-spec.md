...
**Fallback supplier — CED Stone Group "Yellow Granite" (quote QTE2006941, 19 Jun 2026):** 30mm yellow granite **600 × 300** paving @ **£62.16/m² ex VAT** (120.24 m² = £7,474.12) + **8 × bull-nosed granite steps 400 × 1200mm @ £85.86** (£686.88) + **£560 haulage** = **£8,721.00 ex VAT / £10,465.20 inc**. **In stock — ~1 week lead time from order.** This is **marginally more expensive** than Paving Superstore once compared like-for-like, so it is held as the **fallback**. *(Note the CED paving is **600 × 300**, not 600 × 600 — confirm the preferred format when comparing.)*
